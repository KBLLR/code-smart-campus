...
// import { SVGPathProperties } from '../path/SVGPathProperties.js'; // Replaced
...
export class RadialGraph extends Interface {
    ...
    calculateLookup() {
        ...
        while (i <= 1) {
            const point = this.helperPath.getPointAtLength(i * length); // properties.getPointAtLength(i * length);
