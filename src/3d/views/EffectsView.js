...
export class EffectsView {
  constructor({ renderer, scene, camera } = {}) {
    if (!renderer) throw new Error("[EffectsView] renderer is required.");
    if (!scene) throw new Error("[EffectsView] scene is required.");
    if (!camera) throw new Error("[EffectsView] camera is required.");
